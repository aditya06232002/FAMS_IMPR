...
def manually_fill():
    ...
    def fill_attendance():
        ...
        try:
            global cursor
            connection = pymysql.connect(host='localhost', user='root', password='', db='facerec')
...
#Live detection could not be performed because face recognition module is not available.
def take_img():
    l1 = txt.get()
    l2 = txt2.get()
    if l1 == '':
        ...
        try:
            ...
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    if(len(eyes)>=2):
				        #Check if program is running for detectioni
                        if(first_read):
                ...
                with open(cs, newline="") as file:
                    ...
                    for col in reader:
                        ...
                        for row in col:
                            # i've added some styling
                            label = tkinter.Label(root, width=8, height=1, fg="black", font=('times', 15, ' bold '),
                                                  bg="gray", text=row, relief=tkinter.RIDGE)
                            label.grid(row=r, column=c)
                            c += 1
                        r += 1
                root.mainloop()
...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System", bg="#BDBDB7", fg="#FFFFF8", width=50,
...
lbl = tk.Label(window, text="Enter Enrollment", width=20, height=2,fg="#646495"  ,bg="#FFFFB9"  , font=('times', 15, ' bold '))
...
txt = tk.Entry(window, validate="key", width=20, bg="white", fg="#A9A9A9", font=('times', 25, ' bold '))
txt['validatecommand'] = (txt.register(testVal),'%P','%d')
txt.place(x=550, y=210)

lbl2 = tk.Label(window, text="Enter Name", width=20,fg="#646495"  ,bg="#FFFFB9"  , height=2, font=('times', 15, ' bold '))
lbl2.place(x=200, y=300)

txt2 = tk.Entry(window, width=20, bg="white", fg="#A9A9A9", font=('times', 25, ' bold '))
txt2.place(x=550, y=310)

clearButton = tk.Button(window, text="Clear",command=clear,fg="#646495"  ,bg="#FFFFB9"  ,width=10  ,height=1 ,activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear",command=clear1,fg="#646495"  ,bg="#FFFFB9"  ,width=10 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton1.place(x=950, y=310)

AP = tk.Button(window, text="Check Register students",command=admin_panel,fg="#45458B"  ,bg="#D0D020"  ,width=20 ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
AP.place(x=880, y=500)

takeImg = tk.Button(window, text="Take Images",command=take_img,fg="#45458B"  ,bg="#D0D020"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
takeImg.place(x=200, y=500)

trainImg = tk.Button(window, text="Train Images",fg="#45458B",command=trainimg ,bg="#D0D020"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
